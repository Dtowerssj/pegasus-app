                    ...
                    <div class="row">
                        ...
                        <form>
                            <div class="card-holder">
                                    <input type="text" placeholder="Nombre del Titular de la Tarjeta" id="card-name" class="card-name" />
                                ...
                                <div class="pay-btn">
                                    <input type="submit" class="btn btn-info btn-lg" value="Pagar Ahora" />
                                </div>
